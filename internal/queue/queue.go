 ...
 * из своего буфера (CAPTCHA_DEADLINE_EXCEEDED), чтобы слот занял свежий запрос.
 * Полная очередь живых — drop (CAPTCHA_QUEUE_LIMIT) или wait до места / дедлайна.
...
const (
	ReasonQueueLimit       = "CAPTCHA_QUEUE_LIMIT"
	ReasonDeadlineExceeded = "CAPTCHA_DEADLINE_EXCEEDED"
